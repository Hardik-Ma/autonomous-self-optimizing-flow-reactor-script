% At the beginning of your script, clear the old version
clear TSEMO_V4_1a_OPC_with_prior_NoTic
clear all
close all
clc
...
%% Step 4: Create chemical prior functions
%% Step 4: Create chemical prior functions based on your reaction system
fprintf('\n=== Creating chemical prior functions for GP models ===\n');
prior_functions = create_learn_from_LHC_priors_bounded(lb, ub, c1_0, c2_0, V_R, X, Y, 0.2);

%% Step 5: Start algorithm with prior functions
opt = TSEMO_options;
opt.maxeval = 10;
opt.NoOfBachSequential = 1;

% Call TSEMO WITH prior functions
